...
function setup() {
  ...
  slignShot = new SlingShot(this.polygon,{x:100,y:200});

  ground = new Ground(350,285,60,10);

  block1 = new Box(300,275,20,40);
  block2 = new Box(330,275,20,40);
  block3 = new Box(360,275,20,40);
  block4 = new Box(390,275,20,40);
  block5 = new Box(420,275,20,40);
  block6 = new Box(450,275,20,40);
  block7 = new Box(480,275,20,40);

  block8 = new Box(330,235,20,40);
  block9 = new Box(360,235,20,40);
  block10 = new Box(390,235,20,40);
  block11= new Box(420,235,20,40);
  block12= new Box(450,235,20,40);

  block13 = new Box(360,195,20,40);
  block14= new Box(390,195,20,40);
  block15 = new Box(420,195,20,40);

  block16 = new Box(390,155,20,40);
}
